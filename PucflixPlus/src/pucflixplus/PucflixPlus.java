...
public class PucflixPlus extends Application {
    ...
    public void start(Stage plano) {
        ...
        SVGPath cavalo;
        cavalo = new SVGPath();
        cavalo.setContent(svgPathCavalo);
        cavalo.setFill(Color.GOLD); // experimente cavalo.setFill(Color.WHITE); 
        cavalo.setScaleX(0.1);     // experimente ajustar a escala em X
        cavalo.setScaleY(0.1);     // experimente ajustar a escala em Y
        cavalo.setOpacity(1.0); 
        cavalo.setStrokeWidth(2);
        cavalo.setStroke(Color.BLACK);
        ...
        botao.setOnAction((ActionEvent event) -> {
            ...
            if (painel.getChildren().contains(cavalo)) {
                painel.getChildren().remove(cavalo);
            }

            if (((String) comboUm.getSelectionModel().getSelectedItem()).equals("Aventura")) {
                indice = 0;
                painel.getChildren().add(cavalo);
                cavalo.setTranslateX(1100-10);
                cavalo.setTranslateY(0);
            }
